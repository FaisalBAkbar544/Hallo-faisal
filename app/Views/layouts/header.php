    ...
    $user = ['username' => 'Guest', 'created_at' => date('Y-m-d')];
      ...
      <nav class="app-header navbar navbar-expand bg-body">
        ...
        <div class="container-fluid">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-md-block">  <a href="<?= base_url('dash-home') ?>" class="nav-link">Home</a></li>
            <li class="nav-item d-none d-md-block">  <a href="<?= base_url('dash-contact') ?>" class="nav-link">Contact</a></li>
          </ul>
          ...
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
               <?php $user = $user ?? ['username' => 'Guest', 'created_at' => date('Y-m-d')]; ?>
              ...
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                ...
                <li class="user-header text-bg-primary">
                  ...
                  />
                  <p>
                    <?= esc($user['username']) ?> - Web Developer<br>
